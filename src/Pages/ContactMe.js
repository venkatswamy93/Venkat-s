...
const ContactMe = () => {
    ...
    const handleSubmit = e => {
        e.preventDefault();
        emailjs.sendForm(`service_spdi3bg`, `template_647w0ih`, form.current, `U8CNGTSUjI8JfAhLG`)
                    ...
                    <div data-aos="fade-right" className="w-full max-w-xl p-5 rounded-xl ">
                        ...
                        <div className='card'>
                            ...
                            <figure style={{ justifyContent: 'flex-start' }} className='flex items-center' >
                                ...
                                <a href="tel:+8801737509339">+91 8328016507</a>
                            </figure>
                        </div>
                        <div className='my-5'>
                            ...
                            <figure style={{ justifyContent: 'flex-start' }} className='flex items-center' >
                                ...
                                <a href="mailto:venkatswamyj@gmail.com">venkatswamyj@gmail.com</a>
                            </figure>
                        </div>
                        <div>
