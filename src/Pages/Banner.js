...
import bannerPhoto from '../Assests/Images/VenkatJ.jpeg';
import Typed from "react-typed";


const Banner = () => {
    const handleDownloadCV = () => {
        window.open('https://drive.google.com/drive/u/0/folders/111xfb4O4PHjMBs7OEHARv5GT3zXo5G09');
    }
    return (
        <div style={{}}>
            <div data-aos="zoom-in" className="hero h-[85vh]">
                <div className="hero-content flex-col lg:flex-row-reverse gap-5">
                    ...
                    <div className='w-xs md:max-w-4xl' >
                        ...
                        <h1 className="text-2xl md:text-5xl font-bold py-1">Jampana Venkat Swamy</h1>
                        <Typed
